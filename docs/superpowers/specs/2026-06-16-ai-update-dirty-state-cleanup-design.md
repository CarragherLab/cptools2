...
- Branch: `ai-update`
- Last committed checkpoint before this design: `a10d4a3 docs: plan DINO worktree consolidation`
- Cleanup design checkpoint: `5d37e78 docs: design ai-update dirty-state cleanup`
- Dirty runtime files:
