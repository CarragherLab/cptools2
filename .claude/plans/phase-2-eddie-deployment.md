...
- Run end-to-end test on a small real plate on Eddie
...
| 230 | End-to-End Eddie Test | Validation | Full pipeline run on real plate, output verification, install script tested |
