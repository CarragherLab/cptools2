...
#$ -l h_rt=00:30:00
#$ -l h_rss=16G
#$ -o /exports/eddie/scratch/$USER/cptools2-ai-update/logs/deepprofiler_$JOB_ID.log
#$ -e /exports/eddie/scratch/$USER/cptools2-ai-update/logs/deepprofiler_$JOB_ID.err
