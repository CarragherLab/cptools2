...
#$ -l h_rt=00:20:00
#$ -l h_rss=8G
#$ -o /exports/eddie/scratch/$USER/cptools2-ai-update/logs/cellprofiler_$JOB_ID.log
#$ -e /exports/eddie/scratch/$USER/cptools2-ai-update/logs/cellprofiler_$JOB_ID.err
